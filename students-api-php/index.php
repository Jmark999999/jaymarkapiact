<?php
    ...
    if($method == "PUT"){
        ...
        if(isset($_GET['id'])){
            ...
            $email = $value['email'];   
            $phone_no =  $value['phoneno'];  
            $sql = "UPDATE tblstudents SET firstname = '$first_name', lastname = '$last_name', birthday = '$birthday', address = '$address', course = '$course', year = '$year', email = '$email', phoneno = '$phone_no'z WHERE id = " . $_GET['id'];
            $response =
            [
